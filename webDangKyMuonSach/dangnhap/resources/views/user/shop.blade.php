                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span>300</span> Products found</h6>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{URL::asset('uploads')}}/{{$pro->image}}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="{{route('cart.add',['book_id'=>$pro->book_id])}}"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="#">{{$pro->book_title}}</a></h6>
                                    <h5>tác giả: {{$pro->book_author}}</h5>
                                </div>
                            </div>
                        </div>
                        @endforeach
