                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                                ...
                                <ul>
                                    @if(Auth::check())
                                        <li><a href="{{route('home.index')}}"><i class="fa fa-key"></i> Thông tin của bạn</a></li>
                                        <li><a href="{{route('home.index')}}"><i class="fa fa-key"></i> Thông tin mượn sách</a></li>
                                        <li><a href="{{route('login.out')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
                                    @else
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href=""><img src="{{URL::asset('site')}}/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            <li><a href="{{route('home.shop')}}">Library</a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address:  đường 60-49 Quận 5, Hồ Chí Minh</li>
